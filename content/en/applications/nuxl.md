...
**Figure Output folder**: To generate FDR-filtered result files, a path to the output folder needs to be provided.
...
**Figure Output directory**: Upon pipeline execution, the pop-up window is used to enter the absolute path to the output folder.
