...
<details>
<summary style="padding:0 0 0 25px" style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{marcu2021hla,
...
<pre><code>@article{dai2021proteomics,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{starke2020tracing,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{wein2020computational,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@incollection{rurik2020metabolomics,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{jeong2020flashdeconv,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bichmann2020diaproteomics,
title={DIAproteomics: A Multifunctional Data Analysis Pipeline for Data-Independent Acquisition Proteomics and Peptidomics},
author={Bichmann, Leon and Gupta, Shubham and Rosenberger, George and Kuchenbecker, Leon and Sachsenberg, Timo and Ewels, Phil and Alka, Oliver and Pfeuffer, Julianus and Kohlbacher, Oliver and Röst, Hannes},
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{kutuzova2020smartpeak,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{stutzer2020analysis,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{netz2020openpepxl,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{nothias2020feature,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{scheidt2020phosphoproteomics,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{pfeuffer2019epifany,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{hulstaert2019thermorawfileparser,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bichmann2019mhcquant,
title={MHCquant: Automated and reproducible data analysis for immunopeptidomics},
author={Bichmann, Leon and Nelde, Annika and Ghosh, Michael and Heumos, Lukas and Mohr, Christopher and Peltzer, Alexander and Kuchenbecker, Leon and Sachsenberg, Timo and Walz, Juliane S and Stevanović, Stefan and others},
journal={Journal of proteome research},
volume={18},
number={11},
pages={3876--3884},
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{loffler2019multi,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{gruening2018recommendations,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{kahles2018comprehensive,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{vizcaino2017mzidentml,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{audain2017depth,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{rost2017automated,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{da2017biocontainers,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{pfeuffer2017denbi,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{veit2016lfqprofiler,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{navarro2016multi,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{aiche2015workflows,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{aicheler2015retention,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{ranninger2015nephron,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{rost2015efficient,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{nilse2015toward,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{rost2014openswath,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{rost2014pyopenms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{kenar2014automated,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{griss2014mztab,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{walzer2014qcml,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{weisser2013automated,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{walzer2013mzquantml,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{junker2012toppas,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{nahnsen2012silico,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bertsch2011openms,
...
- S. Nahnsen, A. Bertsch, J. Rahnenführer, A. Nordheim, and O. Kohlbacher, “Probabilistic consensus scoring improves tandem mass spectrometry peptide identification,” Journal of proteome research, vol. 10, iss. 8, p. 3332–3343, 2011.

<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{nahnsen2011probabilistic,
title={Probabilistic consensus scoring improves tandem mass spectrometry peptide identification},
author={Nahnsen, Sven and Bertsch, Andreas and Rahnenführer, Jörg and Nordheim, Alfred and Kohlbacher, Oliver},
journal={Journal of proteome research},
volume={10},
number={8},
pages={3332--3343},
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bielow2011mssimulator,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@incollection{reinert2010openms,
title={OpenMS and TOPP: open source software for LC-MS data analysis},
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@phdthesis{sturm2010openms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bertsch2010optimal,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{sturm2009toppview,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bielow2009openms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{bertsch2009novo,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{pfeifer2009improving,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@incollection{nilse2009silacanalyzer,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{kohlbacher2009openms,
title={OpenMS and TOPP: Open source software for lc-ms data analysis},
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{sturm2008openms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{schulz2008computational,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{lange2008analysis,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{kohlbacher2007topp,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{lange2007geometric,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{reinert2006openms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{lange2006high,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@inproceedings{lange2005openms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@incollection{gropl2005algorithms,
...
<details>
<summary style="padding:0 0 0 25px">[Bibtex]</summary>
<pre><code>@article{gropl2005openms,
